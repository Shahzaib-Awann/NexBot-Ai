...
export default defineConfig({
  ...
  dbCredentials: {
    url: `mysql://${process.env.DATABASE_USER}:${process.env.DATABASE_PASSWORD}@${process.env.DATABASE_HOST}:${process.env.DATABASE_PORT}/${process.env.MYSQL_NAME}?ssl-mode=REQUIRED`,   // <- Database connection URL from environment variable
    ssl: {
